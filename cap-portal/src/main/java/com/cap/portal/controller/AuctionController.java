...
//    public String saveAuctionRecord(@PathVariable Long itemId, CapAuctionRecord auctionrecord, HttpServletRequest request) throws RecordException {
//        //从session中获取user的id
//        CapUser user = (CapUser) request.getAttribute("user");
//        //设置好商品竞拍记录的user id
//        auctionrecord.getAuctiontime();
//        //设置商品竞拍记录当前时间
//        auctionrecord.setAuctiontime(new Date());
//
//        auctionService.addAuctionrecord(auctionrecord);
//
//        return ""+auctionrecord.getItemId();
//    }
    @RequestMapping("/saveAuctionRecord")
